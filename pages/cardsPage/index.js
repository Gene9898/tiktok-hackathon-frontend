...
const Cards = () => {
    ...
    <div className="flex flex-wrap">
      ...
      {isReported && (
        <div className="fixed inset-0 flex items-center justify-center z-50">
          <div className="bg-black w-[100%] sm:w-[60%] rounded-3xl p-10 container mx-auto">
  ...
  <div className="sm:space-x-8 space-x-2">
    <button
      className="bg-blue-500 hover:bg-blue-400 px-3 py-1 rounded-lg text-xs xs:text-sm sm:text-base lg:text-xl"
      onClick={submitForm}
    >
      Save
    </button>
    <button
      className="bg-rose-600 hover:bg-rose-500 px-3 py-1 rounded-lg text-xs xs:text-sm sm:text-base lg:text-xl"
      onClick={handleClose}
    >
      Cancel
    </button>
